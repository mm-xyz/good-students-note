...
2. **字級刪除線** — **反白文字、選取穩定後自動套用**,不用再點按鈕
   ...
   (這條語意的來歷、跟自動套用的判定策略,見 `docs/adr/0018-cutplan-editor-strike-interaction-model.md`)。
...
- **選取穩定判定是時間 heuristic,不是精確事件**(2026-08-11,見
  `docs/adr/0018-cutplan-editor-strike-interaction-model.md`)。放開手指/滑鼠後等 60ms、純鍵盤選取等 450ms 沒
